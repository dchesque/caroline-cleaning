...
# Criar O Context Completo Desse Projeto Plan

> criar o .context completo desse projeto
...
- **Total symbols discovered:** 247
- **Architecture layers:** Utils, Services, Components, Controllers
- **Detected patterns:** Service Layer
- **Entry points:** types\index.ts, lib\supabase\server.ts
