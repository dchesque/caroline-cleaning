...
export const metadata: Metadata = {
    title: 'Terms of Service | Chesque Premium Cleaning',
    description: 'Terms of Service for Chesque Premium Cleaning. Understanding our cleaning service agreements, policies, and conditions.',
}
                ...
                <div className="prose prose-brandy-rose max-w-none space-y-12">
                    <section>
                        ...
                        <p className="text-brandy-rose-900/80 leading-relaxed">
                            By booking services with Chesque Premium Cleaning, you agree to comply with and be bound by the following terms and conditions. These terms govern our professional relationship with you.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-brandy-rose-900/80 leading-relaxed">
                            Chesque Premium Cleaning reserves the right to update these terms at any time. Changes will be effective immediately upon posting to our website.
                        </p>
                    </section>
                </div>
            </div>
